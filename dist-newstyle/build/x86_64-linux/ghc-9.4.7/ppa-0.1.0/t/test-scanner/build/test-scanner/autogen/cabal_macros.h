...
/* package ppa-0.1.0 */
#ifndef VERSION_ppa
#define VERSION_ppa "0.1.0"
#endif /* VERSION_ppa */
#ifndef MIN_VERSION_ppa
#define MIN_VERSION_ppa(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ppa */
...
#define CURRENT_COMPONENT_ID "ppa-0.1.0-inplace-test-scanner"
